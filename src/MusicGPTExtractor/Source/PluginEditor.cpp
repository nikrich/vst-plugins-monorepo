...
namespace {
    // Stem display names and expected file suffixes
    struct StemInfo {
        const char* name;
        const char* suffix;
    };

    constexpr StemInfo kStemTypes[] = {
        { "Vocals", "vocals" },
        { "Drums", "drums" },
        { "Bass", "bass" },
        { "Other", "other" },
    ...
    , proc(p)
{
    ...
    settingsPanel.onApiKeySaved = [this](const juce::String& apiKey) {
    ...
    juce::String storedKey = ui::SettingsPanel::loadStoredApiKey();
